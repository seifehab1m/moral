...
const inputVariants = cva(
  cn(
    "border-b border-b-[1.5px] dark:bg-input/30 border-input flex h-9 w-full min-w-0 rounded-md bg-transparent py-3 lg:py-5 text-base",
    "transition-[color,box-shadow] outline-none file:text-red-500",
