  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "*:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:font-medium",
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <MoveRightIcon className="size-5 text-primary" />
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          "bg-primary text-grey-2", // variant this
          ...
          "max-h-(--radix-select-content-available-height) min-w-[8rem] origin-(--radix-select-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-md border shadow-md",
          position === "popper" &&
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn("text-red-500 px-2 py-1.5 text-xs", className)}
      {...props}
    />
  );
}
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-grey-2 focus:text-primary", // variant this
        "[&_svg:not([class*='text-'])]:text-muted-foreground relative flex w-full cursor-default items-center gap-2",
        "rounded-sm py-1.5 pr-8 pl-2 text-sm lg:text-lg outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
