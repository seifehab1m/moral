...
export function FlagshipSpotlight() {
  return (
    <section className="relative z-10 flex flex-col lg:flex-row lg:items-end justify-between text-white">
      <div className="relative z-10 px-4 py-6 lg:ps-[160px] lg:pe-[148px] lg:py-20 bg-primary min-h-[402px] lg:min-h-[850px] rounded-ee-[52px] lg:rounded-ee-[200px] lg:w-1/2">
      ...
      <Image className="object-cover" src="/cta-image.jpg" alt="" fill />
      <Button
